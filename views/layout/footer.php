                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        ...
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">Ducngph46559@fpt.ed.vn </a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024 <b>33Boy</b> Được tạo  <i class="fa fa-heart text-danger"></i> bởi <b>Team Duck</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
